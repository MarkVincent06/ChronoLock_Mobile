    ...
    if (privilegeStatus === "Granted") {
      ...
      try {
        ...
        await axios.post(`${API_URL}/remote-access/insertAccessLog`, {
          ...
          action: `Faculty has attempted to unlock the ERP Laboratory.`,
        ...
        try {
          ...
          if (scheduleResponse.data && scheduleResponse.data.success) {
            if (scheduleResponse.data.isScheduled) {
              ...
              // THIS IS FACULTY WHERE HE/SHE CAN OPEN THE LAB ONLY AT SCHEDULED TIME
              Alert.alert(
                "Notice",
                "You can only open the lab on your scheduled time."
              );
