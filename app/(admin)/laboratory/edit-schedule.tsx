...
const EditSchedule = () => {
  ...
  React.useEffect(() => {
    ...
    setLoading(true);
    axios
      .get(`${API_URL}/schedules/${scheduleID}`)
      .then((res) => {
        if (res.data && res.data.success && res.data.data) {
          ...
          setFormData({
            ...
            userID: d.userID || "",
            instFirstName: d.instFirstName || d.instFirstName || "",
            instLastName: d.instLastName || d.instLastName || "",
            program: d.program || "",
            section: d.section || "",
            year: d.year || "",
            semester: d.semester || "",
            ...
            endTime: d.endTime || "",
            startDate: formatDateFromISO(d.startDate),
            endDate: formatDateFromISO(d.endDate),
            day: d.day || "",
            scheduleStatus: d.scheduleStatus || "",
            scheduleType: d.scheduleType || "",
          });
        } else {
          alert(res.data.message || "Failed to fetch schedule data.");
        }
      })
      .catch((err) => {
        alert(
  ...
  const handleSaveChanges = () => {
    ...
    axios
      .put(`${API_URL}/schedules/${scheduleID}/`, formData)
      .then((res) => {
