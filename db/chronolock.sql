...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2024 at 06:00 AM
...
(35, '2024_07_25_031204_create_make_up_schedules_table', 4),
(44, '0001_01_01_000000_create_users_table', 5),
(45, '0001_01_01_000001_create_cache_table', 5),
(46, '0001_01_01_000002_create_jobs_table', 5),
(47, '2024_06_21_114742_create_schedules_table', 5),
(48, '2024_06_22_052729_create_class_lists_table', 5),
(49, '2024_06_22_052730_create_attendances_table', 5),
(50, '2024_06_23_114935_create_student_masterlists_table', 5),
(51, '2024_06_28_152207_create_user_logs_table', 5),
(52, '2024_07_30_035535_create_rfid_temps_table', 5);
...
CREATE TABLE `schedules` (
  ...
  `userID` varchar(255) DEFAULT NULL,
  `instFirstName` varchar(255) DEFAULT NULL,
  `instLastName` varchar(255) DEFAULT NULL,
...
ALTER TABLE `schedules`
  ...
  ADD UNIQUE KEY `schedules_coursecode_unique` (`courseCode`),
...
--
ALTER TABLE `student_masterlists`
  MODIFY `MIT_ID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `user_logs`
  MODIFY `idLogs` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `attendances`
  ADD CONSTRAINT `attendances_classid_foreign` FOREIGN KEY (`classID`) REFERENCES `class_lists` (`classID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `attendances_userid_foreign` FOREIGN KEY (`userID`) REFERENCES `users` (`idNumber`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `class_lists`
--
ALTER TABLE `class_lists`
  ADD CONSTRAINT `class_lists_scheduleid_foreign` FOREIGN KEY (`scheduleID`) REFERENCES `schedules` (`scheduleID`);

--
-- Constraints for table `schedules`
--
ALTER TABLE `schedules`
  ADD CONSTRAINT `schedules_userid_foreign` FOREIGN KEY (`userID`) REFERENCES `users` (`idNumber`) ON UPDATE CASCADE;
...
ALTER TABLE `student_masterlists`
  ...
  ADD CONSTRAINT `student_masterlists_userid_foreign` FOREIGN KEY (`userID`) REFERENCES `users` (`idNumber`) ON UPDATE CASCADE;

--
-- Constraints for table `user_logs`
--
ALTER TABLE `user_logs`
  ADD CONSTRAINT `user_logs_userid_foreign` FOREIGN KEY (`userID`) REFERENCES `users` (`idNumber`) ON UPDATE CASCADE;
COMMIT;
